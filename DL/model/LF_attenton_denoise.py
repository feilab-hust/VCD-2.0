...
# def AngleAttention(layer,angRes,name='AngleAttention'):
#     view_num = angRes * angRes
#
#     with tf.variable_scope(name):
#
#         n1 = ViewAttenionBlock(layer, out_channel=view_num, name='Atten_B1')
#         n2 = merge([layer, n1], name='skip1')
#         n2 = ViewAttenionBlock(n2, out_channel=view_num, name='Atten_B2')
#         n3 = merge([layer, n1, n2], name='skip2')
#         n3 = ViewAttenionBlock(n3, out_channel=view_num, name='Atten_B3')
#
#     return n3
...
def LF_attention_denoise(LFP, output_size, angRes=11, sr_factor=7, upscale_mode='one_step', is_train=True, reuse=False,
                         name='LF_attention_denoise', **kwargs):
    view_num = angRes ** 2
    ...
    with tf.variable_scope(name, reuse=reuse):
        ...
        #out = LF_SA_small(LFP=out, output_size=output_size, sr_factor=sr_factor,
                          #angRes=angRes, reuse=False, name=name, channels_interp=64,
                          #transform_layer='SAI2Macron')
        return out
