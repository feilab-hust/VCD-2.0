...
class Dataset:
    ...
    def iter(self):
        ...
        if self.epoch < self.n_epochs:
            ...
            # return hr_pyramid, [self.training_ScanView[i] for i in shuffle_idx], idx - nt, self.epoch
            # return np.concatenate(hr_pyramid)[None,...],np.concatenate([self.training_ScanView[i] for i in shuffle_idx])[None,...] , idx - nt, self.epoch
